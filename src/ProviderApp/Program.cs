...
builder.Services.AddSwaggerGen(c =>
{
    ...
    { 
        Title = "Provider Application API", 
        Version = "v1",
        Description = "API for provider management, route management, and trip operations"
    });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Provider Application API v1");
...
app.MapGet("/health", () => Results.Ok(new { Status = "Healthy", Service = "Provider Application" }));

Console.WriteLine("🚌 Provider Application Starting...");
